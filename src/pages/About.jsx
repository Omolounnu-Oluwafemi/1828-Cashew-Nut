    ...
    return (
        <>
            ...
            <Row className="flexedSections">
                ...
                <Col>
                    <OtherSections title={"Vision"} details={"To become one of the best cashew nut export company in Africa and the world at large, becoming a reputable export company in enhancing the value of the Nigerian Agricultural Product."}
                    /> 
                </Col>
            </Row>
